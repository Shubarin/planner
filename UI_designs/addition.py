...
class Add_Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Подробнее"))
        self.pushButton.setText(_translate("Form", "Печать.."))
        self.pushButton.setShortcut(_translate("Form", "Meta+P"))
        self.pushButton_2.setText(_translate("Form", "Экспорт..."))
        self.pushButton_2.setShortcut(_translate("Form", "Meta+S"))
